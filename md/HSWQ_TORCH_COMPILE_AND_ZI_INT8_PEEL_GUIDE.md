# HSWQ Torch Compile Node and Z Image / INT8 Peel Fix — Technical Guide
...
| Commit | Subject |
|--------|---------|
| `06d3ac2` | `feat: add HSWQTorchCompileModel node for HSWQ torch.compile` |
| `06993f7` | `fix: peel INT8 protect under PRODUCT load so SDXL INT8 survives after Z Image` |

This manual answers four required sections:

1. **Nodes created or modified**
2. **Full source** of created or modified code
3. **Meaning** of that code
4. **Z Image / INT8 peel fix** added in the same work stream

Style matches other public manuals under `md/`.
